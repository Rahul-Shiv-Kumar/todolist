function addTask() {
    ...
    if (newTask != "") {
        ...
        /* Step 4 below here */ 
      input.value = "";
      input.placeholder = "Add Next Item";
    }
}
...
function doAbout() {
  ...
  var da = document.getElementById("divabout");
  var name = prompt("Your Name Please: ");
  if(name ==null || name==""){
    name = prompt("Plase enter a valid Name:")
    da.innerHTML = "The Aurthur is "+ name;
    da.className= 'aboutcolor';
  } else{
  da.innerHTML = "The Aurthur is "+ name;
  da.className= 'aboutcolor';
  }
